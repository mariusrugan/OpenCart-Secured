...
function getProducts() {
	...
	$.ajax({
		url: 'index.php?token=<?php echo $this->request->get['token']; ?>&route=sale/coupon/category&category_id=' + $('#category').attr('value'),
		dataType: 'json',
...
function getProduct() {
	...
	$.ajax({
		url: 'index.php?token=<?php echo $this->request->get['token']; ?>&route=sale/coupon/product',
		type: 'POST',
		dataType: 'json',
