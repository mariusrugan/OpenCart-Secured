...
function addGeoZone() {
	...
	$('#zone' + zone_to_geo_zone_row).load('index.php?token=<?php echo $this->request->get['token']; ?>&route=localisation/geo_zone/zone&country_id=' + $('#country' + zone_to_geo_zone_row).attr('value') + '&zone_id=0');
